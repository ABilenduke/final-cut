...
| 1.2 | 02 (TBD) | Refund + booking-confirmation notifications via dispatch outbox |
| 1.3 | 03 (TBD) | BookingResource cancel/refund/resend/flag actions; real refunds in CancellationFollowupQueue |
| 1.4 | 04 (TBD) | Per-showtime seat-occupancy map |
| 1.5 | 05 (TBD) | Walk-up / POS booking creation |
| 1.6 | 06 (TBD) | Copy-week scheduling tool |
| 1.7 | 07 (TBD) | Dashboard KPI widgets |
| 1.8 | 08 (TBD) | Dispatch-outbox ops surface (visibility + retry/un-park) |
| 1.9 | 09 (TBD) | AdminUserResource (staff management) |
| 1.10 | 10 (TBD) | RentalInquiryResource + ContactSubmission persistence/resource |

## Phase 2 — Content CMS

| Step | Plan doc | Summary |
| ---- | -------- | ------- |
| 2.1 | 11 (TBD) | CMS pilot: Neural Ticker (model → resource → cached API → frontend) |
| 2.2 | 12 (TBD) | Blog (replaces `frontend/app/data/blog.ts`) |
| 2.3 | 13 (TBD) | FAQ + Careers (prerender → ISR flips) |
| 2.4 | 14 (TBD) | Private-screening packages + contact/hours from Location data |
| 2.5 | 15 (TBD) | Site settings store + home membership pitch |
| 2.6 | 16 (TBD) | Home hero slots (real showtimes) + featured-movie / menu-item curation flags |
