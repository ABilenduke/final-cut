...
| 5.3 ✅ | [03](03-pay-with-saved-card.md) | Pay with saved card: checkout picker + customer-attached intents |
| 5.4 ✅ | [04](04-calendar-views.md) | Calendar Week/List views: BridgeWeekStrip + BridgeAgendaList, toolbar options enabled |
