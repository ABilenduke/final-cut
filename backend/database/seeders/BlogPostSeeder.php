...
/**
 * Imports the three posts that lived in frontend/app/data/blog.ts before
 * admin-v2 Plan 12 — content parity on `make fresh`.
 */
    ...
    public function run(): void
    {
        $posts = [
            [
                ...
                'author_name' => 'Final Cut Staff',
                'published_at' => '2026-04-05',
                'body' => <<<'BODY'
This summer brings several films that were made for the theatrical experience. Without spoiling any surprises, expect at least three releases where the sound design alone is worth the ticket price. We'll be running extended showtimes on our largest screen for opening weekends.
...
BODY,
            ...
            [
                ...
                'body' => <<<'BODY'
After months of careful preparation, we're proud to open our doors. Final Cut isn't just another movie theatre — it's a space built by film lovers, for film lovers.
